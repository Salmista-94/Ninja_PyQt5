...
class ConsoleWidget(QPlainTextEdit):
    ...
    def __init__(self):
        ...
        self.setToolTip(_translate("ConsoleWidget", "Show/Hide (F4)"))
        ...
        self._braces = None
        self.imports = ['import builtins']#__builtin__
    ...
    def _create_context_menu(self):
        ...
        actionCut = self.popup_menu.addAction(_translate("ConsoleWidget", "Cut"))
        actionCopy = self.popup_menu.addAction(_translate("ConsoleWidget", "Copy"))
        actionPaste = self.popup_menu.addAction(_translate("ConsoleWidget", "Paste"))
        actionClean = self.popup_menu.addAction(_translate("ConsoleWidget", "Clean Console"))
        actionCopyHistory = self.popup_menu.addAction(_translate("ConsoleWidget", "Copy History"))
        actionCopyConsoleContent = self.popup_menu.addAction(
            _translate("ConsoleWidget", "Copy Console Content"))
        ...
        if not incomplete:
            ...
            if output is not None:
                if isinstance(output, str):
                    print("has encoded")
                    #output = output.encode('utf8')str()
                self.appendPlainText(output)#output.decode('utf8')
