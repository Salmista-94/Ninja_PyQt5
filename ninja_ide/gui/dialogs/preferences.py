...
class PreferencesWidget(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(_translate("PreferencesWidget", "NINJA-IDE - Preferences"))
        ...
        self._tabs.addTab(self._general, _translate("PreferencesWidget", "General"))
        self._tabs.addTab(self._interface, _translate("PreferencesWidget", "Interface"))
        self._tabs.addTab(self._editor, _translate("PreferencesWidget", "Editor"))
        self._tabs.addTab(self._plugins, _translate("PreferencesWidget", "Plugins"))
        self._tabs.addTab(self._theme, _translate("PreferencesWidget", "Theme"))
        #Buttons (save-cancel)
        hbox = QHBoxLayout()
        self._btnSave = QPushButton(_translate("PreferencesWidget", "Save"))
        self._btnCancel = QPushButton(_translate("PreferencesWidget", "Cancel"))
        hbox = QHBoxLayout()
        ...
        self._btnSave.clicked['bool'].connect(self._save)
        self._btnCancel.clicked['bool'].connect(self._cancel)
...
class GeneralTab(QWidget):
    ...
    def __init__(self, parent):
        ...
        self._tabs.addTab(self._generalConfiguration, _translate("GeneralTab", "General"))
        self._tabs.addTab(self._generalExecution, _translate("GeneralTab", "Execution"))
        self._tabs.addTab(self._shortcutConfiguration, _translate("GeneralTab", "Shortcuts"))
...
class GeneralConfiguration(QWidget):
    ...
    def __init__(self, dialog):
        ...
        groupBoxStart = QGroupBox(_translate("GeneralConfiguration", "On Start:"))
        groupBoxClose = QGroupBox(_translate("GeneralConfiguration", "On Close:"))
        groupBoxWorkspace = QGroupBox(_translate("GeneralConfiguration", "Workspace and Project:"))
        groupBoxReset = QGroupBox(_translate("GeneralConfiguration", "Reset NINJA-IDE Preferences:"))

        #Start
        vboxStart = QVBoxLayout(groupBoxStart)
        self._checkLastSession = QCheckBox(
            _translate("GeneralConfiguration", "Load files from last session"))
        self._checkActivatePlugins = QCheckBox(_translate("GeneralConfiguration", "Activate Plugins"))
        self._checkNotifyUpdates = QCheckBox(
            _translate("GeneralConfiguration", "Notify me of new updates."))
        self._checkShowStartPage = QCheckBox(_translate("GeneralConfiguration", "Show Start Page"))
        ...
        self._checkConfirmExit = QCheckBox(_translate("GeneralConfiguration", "Confirm Exit."))
        ...
        gridWorkspace.addWidget(
            QLabel(_translate("GeneralConfiguration", "Workspace")), 0, 0, Qt.AlignRight)
        ...
        gridWorkspace.addWidget(QLabel(
            _translate("GeneralConfiguration", "Supported Extensions:")), 1, 0, Qt.AlignRight)
        gridWorkspace.addWidget(self._txtExtensions, 1, 1)

        # Resetting preferences
        vboxReset = QVBoxLayout(groupBoxReset)
        self._btnReset = QPushButton(_translate("GeneralConfiguration", "Reset preferences"))
    ...
    def _load_workspace(self):
        path = QFileDialog.getExistingDirectory(
            self, _translate("GeneralConfiguration", "Select Workspace"))
        self._txtWorkspace.setText(path)

    def _load_python_path(self):
        path = QFileDialog.getOpenFileName(self, _translate("GeneralConfiguration", "Select Python Path"))
        if path:
    ...
    def _reset_preferences(self):
        result = QMessageBox.question(self, _translate("GeneralConfiguration", "Reset preferences?"),
            _translate("GeneralConfiguration", "Are you sure you want to reset your preferences?"),
...
class GeneralExecution(QWidget):
    ...
    def __init__(self):
        ...
        groupExecution = QGroupBox(_translate("GeneralExecution", "Workspace and Project:"))
        ...
        hPath.addWidget(QLabel(_translate("GeneralExecution", "Python Path:")))
        ...
        self.check_B = QCheckBox(_translate("GeneralExecution", 
            "-B: don't write .py[co] files on import"))
        self.check_d = QCheckBox(_translate("GeneralExecution", "-d: debug output from parser"))
        self.check_E = QCheckBox(_translate("GeneralExecution", 
            "-E: ignore PYTHON* environment variables (such as PYTHONPATH)"))
        self.check_O = QCheckBox(
            _translate("GeneralExecution", "-O: optimize generated bytecode slightly"))
        self.check_OO = QCheckBox(_translate("GeneralExecution", 
            "-OO: remove doc-strings in addition to the -O optimizations"))
        self.check_Q = QCheckBox(_translate("GeneralExecution", "-Q: division options:"))
        self.comboDivision = QComboBox()
        self.comboDivision.addItems(['old', 'new', 'warn', 'warnall'])
        self.check_s = QCheckBox(_translate("GeneralExecution", 
            "-s: don't add user site directory to sys.path"))
        self.check_S = QCheckBox(_translate("GeneralExecution", 
            "-S: don't imply 'import site' on initialization"))
        self.check_t = QCheckBox(_translate("GeneralExecution", 
            "-t: issue warnings about inconsistent tab usage"))
        self.check_tt = QCheckBox(_translate("GeneralExecution", 
            "-tt: issue errors about inconsistent tab usage"))
        self.check_v = QCheckBox(_translate("GeneralExecution", 
            "-v: verbose (trace import statements)"))
        self.check_W = QCheckBox(_translate("GeneralExecution", "-W: warning control:"))
        self.comboWarning = QComboBox()
        self.comboWarning.addItems(
            ['default', 'ignore', 'all', 'module', 'once', 'error'])
        self.check_x = QCheckBox(_translate("GeneralExecution", "-x: skip first line of source"))
        self.check_3 = QCheckBox(_translate("GeneralExecution", "-3: warn about Python 3.x "
    ...
    def _load_python_path(self):
        path = QFileDialog.getOpenFileName(self, _translate("GeneralExecution", "Select Python Path"))
        if path:
            self._txtPythonPath.setText(path)
...
class InterfaceTab(QWidget):
    ...
    def __init__(self, parent):
        super(InterfaceTab, self).__init__(parent)
        vbox = QVBoxLayout(self)
        self._parent = parent
        self.toolbar_settings = settings.TOOLBAR_ITEMS

        groupBoxExplorer = QGroupBox(_translate("InterfaceTab", "Explorer Panel:"))
        groupBoxGui = QGroupBox(_translate("InterfaceTab", "GUI Customization:"))
        groupBoxToolbar = QGroupBox(_translate("InterfaceTab", "Tool Bar Customization:"))
        groupBoxLang = QGroupBox(_translate("InterfaceTab", "Language:"))

        #Explorer
        vboxExplorer = QVBoxLayout(groupBoxExplorer)
        self._checkProjectExplorer = QCheckBox(
            _translate("InterfaceTab", "Show Project Explorer."))
        self._checkSymbols = QCheckBox(_translate("InterfaceTab", "Show Symbols List."))
        self._checkWebInspetor = QCheckBox(_translate("InterfaceTab", "Show Web Inspector."))
        self._checkFileErrors = QCheckBox(_translate("InterfaceTab", "Show File Errors."))
        self._checkMigrationTips = QCheckBox(_translate("InterfaceTab", "Show Migration Tips."))
        self._checkStatusBarNotifications = QCheckBox(
            _translate("InterfaceTab", "Show Status Bar Notifications."))
        ...
        gridGuiConfig.addWidget(QLabel(
            _translate("InterfaceTab", "Rotate Central")), 1, 0, Qt.AlignCenter)
        gridGuiConfig.addWidget(QLabel(
            _translate("InterfaceTab", "Rotate Lateral")), 1, 1, Qt.AlignCenter)
        gridGuiConfig.addWidget(QLabel(
            _translate("InterfaceTab", "Central Orientation")), 1, 2, Qt.AlignCenter)
        #GUI - Toolbar
        vbox_toolbar = QVBoxLayout(groupBoxToolbar)
        hbox_select_items = QHBoxLayout()
        label_toolbar = QLabel(_translate("InterfaceTab", "Toolbar Items:"))
        ...
        self._btnDefaultItems = QPushButton(_translate("InterfaceTab", "Default Items"))
        ...
        vbox_toolbar.addWidget(QLabel(
            _translate("InterfaceTab", "The New Item will be inserted after the item selected.")))
        #Language
        vboxLanguage = QVBoxLayout(groupBoxLang)
        vboxLanguage.addWidget(QLabel(_translate("InterfaceTab", "Select Language:")))
        self._comboLang = QComboBox()
        self._comboLang.setEnabled(False)
        vboxLanguage.addWidget(self._comboLang)
        vboxLanguage.addWidget(QLabel(_translate("InterfaceTab", 'Requires restart...')))
        ...
        #Signals
        self._btnCentralRotate.clicked['bool'].connect(central_widget.CentralWidget().splitter_central_rotate)
        self._btnPanelsRotate.clicked['bool'].connect(central_widget.CentralWidget().splitter_misc_rotate)
        self._btnCentralOrientation.clicked['bool'].connect(central_widget.CentralWidget().splitter_central_orientation)
        self._btnItemAdd.clicked['bool'].connect(self.toolbar_item_added)
        self._btnItemRemove.clicked['bool'].connect(self.toolbar_item_removed)
        self._btnDefaultItems.clicked['bool'].connect(self.toolbar_items_default)
    ...
    def _load_combo_data(self, combo):
        self.toolbar_items = {
            'separator': [QIcon(resources.IMAGES['separator']),
                'Add Separtor'],
            'new-file': [QIcon(resources.IMAGES['new']), _translate("InterfaceTab", 'New File')],
            'new-project': [QIcon(resources.IMAGES['newProj']),
                _translate("InterfaceTab", 'New Project')],
            'save-file': [QIcon(resources.IMAGES['save']),
                _translate("InterfaceTab", 'Save File')],
            'save-as': [QIcon(resources.IMAGES['saveAs']), _translate("InterfaceTab", 'Save As')],
            'save-all': [QIcon(resources.IMAGES['saveAll']),
                _translate("InterfaceTab", 'Save All')],
            'save-project': [QIcon(resources.IMAGES['saveAll']),
                _translate("InterfaceTab", 'Save Project')],
            'reload-file': [QIcon(resources.IMAGES['reload-file']),
                _translate("InterfaceTab", 'Reload File')],
            'open-file': [QIcon(resources.IMAGES['open']),
                _translate("InterfaceTab", 'Open File')],
            'open-project': [QIcon(resources.IMAGES['openProj']),
                _translate("InterfaceTab", 'Open Project')],
            'activate-profile': [QIcon(resources.IMAGES['activate-profile']),
                _translate("InterfaceTab", 'Activate Profile')],
            'deactivate-profile':
                [QIcon(resources.IMAGES['deactivate-profile']),
                _translate("InterfaceTab", 'Deactivate Profile')],
            'print-file': [QIcon(resources.IMAGES['print']),
                _translate("InterfaceTab", 'Print File')],
            'close-file':
                [self.style().standardIcon(QStyle.SP_DialogCloseButton),
                _translate("InterfaceTab", 'Close File')],
            'close-projects':
                [self.style().standardIcon(QStyle.SP_DialogCloseButton),
                _translate("InterfaceTab", 'Close Projects')],
            'undo': [QIcon(resources.IMAGES['undo']), _translate("InterfaceTab", 'Undo')],
            'redo': [QIcon(resources.IMAGES['redo']), _translate("InterfaceTab", 'Redo')],
            'cut': [QIcon(resources.IMAGES['cut']), _translate("InterfaceTab", 'Cut')],
            'copy': [QIcon(resources.IMAGES['copy']), _translate("InterfaceTab", 'Copy')],
            'paste': [QIcon(resources.IMAGES['paste']), _translate("InterfaceTab", 'Paste')],
            'find': [QIcon(resources.IMAGES['find']), _translate("InterfaceTab", 'Find')],
            'find-replace': [QIcon(resources.IMAGES['findReplace']),
                _translate("InterfaceTab", 'Find/Replace')],
            'find-files': [QIcon(resources.IMAGES['find']),
                _translate("InterfaceTab", 'Find In files')],
            'code-locator': [QIcon(resources.IMAGES['locator']),
                _translate("InterfaceTab", 'Code Locator')],
            'splith': [QIcon(resources.IMAGES['splitH']),
                _translate("InterfaceTab", 'Split Horizontally')],
            'splitv': [QIcon(resources.IMAGES['splitV']),
                _translate("InterfaceTab", 'Split Vertically')],
            'follow-mode': [QIcon(resources.IMAGES['follow']),
                _translate("InterfaceTab", 'Follow Mode')],
            'zoom-in': [QIcon(resources.IMAGES['zoom-in']), _translate("InterfaceTab", 'Zoom In')],
            'zoom-out': [QIcon(resources.IMAGES['zoom-out']),
                _translate("InterfaceTab", 'Zoom Out')],
            'indent-more': [QIcon(resources.IMAGES['indent-more']),
                _translate("InterfaceTab", 'Indent More')],
            'indent-less': [QIcon(resources.IMAGES['indent-less']),
                _translate("InterfaceTab", 'Indent Less')],
            'comment': [QIcon(resources.IMAGES['comment-code']),
                _translate("InterfaceTab", 'Comment')],
            'uncomment': [QIcon(resources.IMAGES['uncomment-code']),
                _translate("InterfaceTab", 'Uncomment')],
            'go-to-definition': [QIcon(resources.IMAGES['go-to-definition']),
                _translate("InterfaceTab", 'Go To Definition')],
            'insert-import': [QIcon(resources.IMAGES['insert-import']),
                _translate("InterfaceTab", 'Insert Import')],
            ...
            'preview-web': [QIcon(resources.IMAGES['preview-web']),
                _translate("InterfaceTab", 'Preview Web')]}
...
class EditorTab(QWidget):
    ...
    def __init__(self):
        ...
        self._tabs.addTab(self._editorGeneral, _translate("EditorTab", "General"))
        self._tabs.addTab(self._editorConfiguration, _translate("EditorTab", "Configuration"))
        self._tabs.addTab(self._editorCompletion, _translate("EditorTab", "Completion"))
        self._tabs.addTab(self._editorSchemeDesigner,
            _translate("EditorTab", "Editor Scheme Designer"))
...
class EditorGeneral(QWidget):
    ...
    def __init__(self):
        ...
        groupBoxMini = QGroupBox(_translate("EditorGeneral", "MiniMap:"))
        groupBoxTypo = QGroupBox(_translate("EditorGeneral", "Typography:"))
        groupBoxScheme = QGroupBox(_translate("EditorGeneral", "Scheme Color:"))
        ...
        formMini.addWidget(QLabel(
            _translate("EditorGeneral", "Enable/Disable MiniMap (Requires restart):\n"
            "(opacity not supported in MAC OS)")), 0, 0,
            Qt.AlignRight)
        formMini.addWidget(QLabel(_translate("EditorGeneral", "Max Opacity:")), 1, 0,
            Qt.AlignRight)
        formMini.addWidget(QLabel(_translate("EditorGeneral", "Min Opacity:")), 2, 0,
            Qt.AlignRight)
        formMini.addWidget(QLabel(
            _translate("EditorGeneral", "Size Area relative to the Editor:")), 3, 0, Qt.AlignRight)
        ...
        gridTypo.addWidget(QLabel(
            _translate("EditorGeneral", "Editor Font:")), 0, 0, Qt.AlignRight)
    ...
    def _load_editor_font(self):
        try:
            ...
            QMessageBox.warning(self,
                _translate("EditorGeneral", "Invalid Font"),
                _translate("EditorGeneral", "This font can not be used in the Editor."))
...
class EditorConfiguration(QWidget):
    ...
    def __init__(self):
        ...
        #Indentation
        groupBoxFeatures = QGroupBox(_translate("EditorConfiguration", "Features:"))
        formFeatures = QGridLayout(groupBoxFeatures)
        formFeatures.addWidget(QLabel(
            _translate("EditorConfiguration", "Indentation Length:")), 1, 0, Qt.AlignRight)
        self._spin = QSpinBox()
        ...
        self._checkUseTabs = QCheckBox(
            _translate("EditorConfiguration", "Use Tabs."))
        self._checkUseTabs.setChecked(settings.USE_TABS)
        self._checkUseTabs.stateChanged[int].connect(self._change_tab_spaces)
        formFeatures.addWidget(self._checkUseTabs, 1, 2, alignment=Qt.AlignTop)
        if settings.USE_TABS:
            self._spin.setSuffix(_translate("EditorConfiguration", "  (tab size)"))
        else:
            self._spin.setSuffix(_translate("EditorConfiguration", "  (spaces)"))
        #Margin Line
        formFeatures.addWidget(QLabel(_translate("EditorConfiguration", "Margin Line:")), 2, 0,
            Qt.AlignRight)
        ...
        self._checkShowMargin = QCheckBox(_translate("EditorConfiguration", "Show Margin Line"))
        self._checkShowMargin.setChecked(settings.SHOW_MARGIN_LINE)
        formFeatures.addWidget(self._checkShowMargin, 2, 2,
            alignment=Qt.AlignTop)
        #End of line
        self._checkEndOfLine = QCheckBox(_translate("EditorConfiguration", "Use Platform End of Line"))
        self._checkEndOfLine.setChecked(settings.USE_PLATFORM_END_OF_LINE)
        formFeatures.addWidget(self._checkEndOfLine, 3, 1,
            alignment=Qt.AlignTop)
        #Find Errors
        self._checkHighlightLine = QCheckBox(_translate("EditorConfiguration",
        ...
        formFeatures.addWidget(self._checkHighlightLine, 4, 1, 1, 2,
            alignment=Qt.AlignTop)
        self._checkErrors = QCheckBox(_translate("EditorConfiguration", "Find and Show Errors."))
        ...
        self._showErrorsOnLine = QCheckBox(
            _translate("EditorConfiguration", "Show Tool tip information about the errors."))
        ...
        self._checkStyle = QCheckBox(
            _translate("EditorConfiguration", "Find and Show Check Style errors."))
        ...
        self._checkStyleOnLine = QCheckBox(
            _translate("EditorConfiguration", "Show Tool tip information about the PEP8 errors."))
        ...
        self._showMigrationTips = QCheckBox(
            _translate("EditorConfiguration", "Show Python3 Migration Tips."))
        ...
        self._checkCenterScroll = QCheckBox(
            _translate("EditorConfiguration", "Center on Scroll."))
        ...
        self._checkTrailing = QCheckBox(_translate("EditorConfiguration", 
        ...
        self._checkShowSpaces = QCheckBox(_translate("EditorConfiguration", "Show Tabs and Spaces."))
        self._checkShowSpaces.setChecked(settings.SHOW_TABS_AND_SPACES)
        formFeatures.addWidget(self._checkShowSpaces, 12, 1, 1, 2,
            alignment=Qt.AlignTop)
        self._allowWordWrap = QCheckBox(_translate("EditorConfiguration", "Allow Word Wrap."))
        self._allowWordWrap.setChecked(settings.ALLOW_WORD_WRAP)
        formFeatures.addWidget(self._allowWordWrap, 13, 1, 1, 2,
            alignment=Qt.AlignTop)
        self._checkForDocstrings = QCheckBox(_translate("EditorConfiguration", 
...
class EditorCompletion(QWidget):
    ...
    def __init__(self):
        ...
        groupBoxClose = QGroupBox(_translate("EditorCompletion", "Complete:"))
        formClose = QGridLayout(groupBoxClose)
        self._checkParentheses = QCheckBox(_translate("EditorCompletion", "Parentheses: ()"))
        self._checkParentheses.setChecked('(' in settings.BRACES)
        self._checkKeys = QCheckBox(_translate("EditorCompletion", "Keys: {}"))
        self._checkKeys.setChecked('{' in settings.BRACES)
        self._checkBrackets = QCheckBox(_translate("EditorCompletion", "Brackets: []"))
        self._checkBrackets.setChecked('[' in settings.BRACES)
        self._checkSimpleQuotes = QCheckBox(_translate("EditorCompletion", "Simple Quotes: ''"))
        self._checkSimpleQuotes.setChecked("'" in settings.QUOTES)
        self._checkDoubleQuotes = QCheckBox(_translate("EditorCompletion", "Double Quotes: \"\""))
        self._checkDoubleQuotes.setChecked('"' in settings.QUOTES)
        self._checkCompleteDeclarations = QCheckBox(
            _translate("EditorCompletion", "Complete Declarations\n"
        ...
        groupBoxCode = QGroupBox(_translate("EditorCompletion", "Code Completion:"))
        formCode = QGridLayout(groupBoxCode)
        self._checkCodeDot = QCheckBox(
            _translate("EditorCompletion", "Activate Code Completion with: \".\""))
...
class EditorSchemeDesigner(QWidget):
    ...
    def __init__(self, parent):
        ...
        btnKeyword = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtOperator = QLineEdit()
        btnOperator = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtBrace = QLineEdit()
        btnBrace = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtDefinition = QLineEdit()
        btnDefinition = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtString = QLineEdit()
        btnString = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtString2 = QLineEdit()
        btnString2 = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtComment = QLineEdit()
        btnComment = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtProperObject = QLineEdit()
        btnProperObject = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtNumbers = QLineEdit()
        btnNumbers = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtSpaces = QLineEdit()
        btnSpaces = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtExtras = QLineEdit()
        btnExtras = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtEditorText = QLineEdit()
        btnEditorText = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtEditorBackground = QLineEdit()
        btnEditorBackground = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtEditorSelectionColor = QLineEdit()
        btnEditorSelectionColor = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtEditorSelectionBackground = QLineEdit()
        btnEditorSelectionBackground = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtSelectedWord = QLineEdit()
        btnSelectedWord = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtCurrentLine = QLineEdit()
        btnCurrentLine = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtFoldArea = QLineEdit()
        btnFoldArea = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtFoldArrow = QLineEdit()
        btnFoldArrow = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtLinkNavigate = QLineEdit()
        btnLinkNavigate = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtBraceBackground = QLineEdit()
        btnBraceBackground = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtBraceForeground = QLineEdit()
        btnBraceForeground = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtErrorUnderline = QLineEdit()
        btnErrorUnderline = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtPep8Underline = QLineEdit()
        btnPep8Underline = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtSidebarBackground = QLineEdit()
        btnSidebarBackground = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))
        self.txtSidebarForeground = QLineEdit()
        btnSidebarForeground = QPushButton(_translate("EditorSchemeDesigner", "Pick Color"))

        hbox = QHBoxLayout()
        hbox.addWidget(QLabel(_translate("EditorSchemeDesigner", "<b>New Theme Name:</b>")))
        self.line_name = QLineEdit()
        hbox.addWidget(self.line_name)
        btnSaveScheme = QPushButton(_translate("EditorSchemeDesigner", "Save Scheme!"))
        hbox.addWidget(btnSaveScheme)

        grid = QGridLayout()
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Keyword:")), 0, 0)
        grid.addWidget(self.txtKeyword, 0, 1)
        grid.addWidget(btnKeyword, 0, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Operator:")), 1, 0)
        grid.addWidget(self.txtOperator, 1, 1)
        grid.addWidget(btnOperator, 1, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Braces:")), 2, 0)
        grid.addWidget(self.txtBrace, 2, 1)
        grid.addWidget(btnBrace, 2, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Definition:")), 3, 0)
        grid.addWidget(self.txtDefinition, 3, 1)
        grid.addWidget(btnDefinition, 3, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "String:")), 4, 0)
        grid.addWidget(self.txtString, 4, 1)
        grid.addWidget(btnString, 4, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "String2:")), 5, 0)
        grid.addWidget(self.txtString2, 5, 1)
        grid.addWidget(btnString2, 5, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Comment:")), 6, 0)
        grid.addWidget(self.txtComment, 6, 1)
        grid.addWidget(btnComment, 6, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Proper Object:")), 7, 0)
        grid.addWidget(self.txtProperObject, 7, 1)
        grid.addWidget(btnProperObject, 7, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Numbers:")), 8, 0)
        grid.addWidget(self.txtNumbers, 8, 1)
        grid.addWidget(btnNumbers, 8, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Spaces:")), 9, 0)
        grid.addWidget(self.txtSpaces, 9, 1)
        grid.addWidget(btnSpaces, 9, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Extras:")), 10, 0)
        grid.addWidget(self.txtExtras, 10, 1)
        grid.addWidget(btnExtras, 10, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Editor Text:")), 11, 0)
        grid.addWidget(self.txtEditorText, 11, 1)
        grid.addWidget(btnEditorText, 11, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Editor Background:")), 12, 0)
        grid.addWidget(self.txtEditorBackground, 12, 1)
        grid.addWidget(btnEditorBackground, 12, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Editor Selection Color:")), 13, 0)
        grid.addWidget(self.txtEditorSelectionColor, 13, 1)
        grid.addWidget(btnEditorSelectionColor, 13, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Editor Selection Background:")), 14, 0)
        grid.addWidget(self.txtEditorSelectionBackground, 14, 1)
        grid.addWidget(btnEditorSelectionBackground, 14, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Editor Selected Word:")), 15, 0)
        grid.addWidget(self.txtSelectedWord, 15, 1)
        grid.addWidget(btnSelectedWord, 15, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Current Line:")), 16, 0)
        grid.addWidget(self.txtCurrentLine, 16, 1)
        grid.addWidget(btnCurrentLine, 16, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Fold Area:")), 17, 0)
        grid.addWidget(self.txtFoldArea, 17, 1)
        grid.addWidget(btnFoldArea, 17, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Fold Arrow:")), 18, 0)
        grid.addWidget(self.txtFoldArrow, 18, 1)
        grid.addWidget(btnFoldArrow, 18, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Link Navigate:")), 19, 0)
        grid.addWidget(self.txtLinkNavigate, 19, 1)
        grid.addWidget(btnLinkNavigate, 19, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Brace Background:")), 20, 0)
        grid.addWidget(self.txtBraceBackground, 20, 1)
        grid.addWidget(btnBraceBackground, 20, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Brace Foreground:")), 21, 0)
        grid.addWidget(self.txtBraceForeground, 21, 1)
        grid.addWidget(btnBraceForeground, 21, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Error Underline:")), 22, 0)
        grid.addWidget(self.txtErrorUnderline, 22, 1)
        grid.addWidget(btnErrorUnderline, 22, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "PEP8 Underline:")), 23, 0)
        grid.addWidget(self.txtPep8Underline, 23, 1)
        grid.addWidget(btnPep8Underline, 23, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Sidebar Background:")), 24, 0)
        grid.addWidget(self.txtSidebarBackground, 24, 1)
        grid.addWidget(btnSidebarBackground, 24, 2)
        grid.addWidget(QLabel(_translate("EditorSchemeDesigner", "Sidebar Foreground:")), 25, 0)
        ...
        self.txtKeyword.textChanged[str].connect(lambda: self.apply_button_style(
                btnKeyword, self.txtKeyword.text()))
        self.txtOperator.textChanged[str].connect(lambda: self.apply_button_style(
                btnOperator, self.txtOperator.text()))
        self.txtBrace.textChanged[str].connect(lambda: self.apply_button_style(btnBrace, self.txtBrace.text()))
        self.txtDefinition.textChanged[str].connect(lambda: self.apply_button_style(
                btnDefinition, self.txtDefinition.text()))
        self.txtString.textChanged[str].connect(lambda: self.apply_button_style(btnString, self.txtString.text()))
        self.txtString2.textChanged[str].connect(lambda: self.apply_button_style(
                btnString2, self.txtString2.text()))
        self.txtSpaces.textChanged[str].connect(lambda: self.apply_button_style(btnSpaces, self.txtSpaces.text()))
        self.txtExtras.textChanged[str].connect(lambda: self.apply_button_style(btnExtras, self.txtExtras.text()))
        self.txtComment.textChanged[str].connect(lambda: self.apply_button_style(
                btnComment, self.txtComment.text()))
        self.txtProperObject.textChanged[str].connect(lambda: self.apply_button_style(
                btnProperObject, self.txtProperObject.text()))
        self.txtNumbers.textChanged[str].connect(lambda: self.apply_button_style(btnNumbers,
                self.txtNumbers.text()))
        self.txtEditorText.textChanged[str].connect(lambda: self.apply_button_style(
                btnEditorText, self.txtEditorText.text()))
        self.txtEditorBackground.textChanged[str].connect(lambda: self.apply_button_style(btnEditorBackground,
                self.txtEditorBackground.text()))
        self.txtEditorSelectionColor.textChanged[str].connect(lambda: self.apply_button_style(btnEditorSelectionColor,
                self.txtEditorSelectionColor.text()))
        self.txtEditorSelectionBackground.textChanged[str].connect(lambda: self.apply_button_style(btnEditorSelectionBackground,
                self.txtEditorSelectionBackground.text()))
        self.txtCurrentLine.textChanged[str].connect(lambda: self.apply_button_style(
                btnCurrentLine, self.txtCurrentLine.text()))
        self.txtSelectedWord.textChanged[str].connect(lambda: self.apply_button_style(
                btnSelectedWord, self.txtSelectedWord.text()))
        self.txtFoldArea.textChanged[str].connect(lambda: self.apply_button_style(
                btnFoldArea, self.txtFoldArea.text()))
        self.txtFoldArrow.textChanged[str].connect(lambda: self.apply_button_style(
                btnFoldArrow, self.txtFoldArrow.text()))
        self.txtLinkNavigate.textChanged[str].connect(lambda: self.apply_button_style(
                btnLinkNavigate, self.txtLinkNavigate.text()))
        self.txtBraceBackground.textChanged[str].connect(lambda: self.apply_button_style(btnBraceBackground,
                self.txtBraceBackground.text()))
        self.txtBraceForeground.textChanged[str].connect(lambda: self.apply_button_style(btnBraceForeground,
                self.txtBraceForeground.text()))
        self.txtErrorUnderline.textChanged[str].connect(lambda: self.apply_button_style(btnErrorUnderline,
                self.txtErrorUnderline.text()))
        self.txtPep8Underline.textChanged[str].connect(lambda: self.apply_button_style(
                btnPep8Underline, self.txtPep8Underline.text()))
        self.txtSidebarBackground.textChanged[str].connect(lambda: self.apply_button_style(btnSidebarBackground,
                self.txtSidebarBackground.text()))
        self.txtSidebarForeground.textChanged[str].connect(lambda: self.apply_button_style(btnSidebarForeground,
                self.txtSidebarForeground.text()))

        btnKeyword.clicked['bool'].connect(lambda: self._pick_color(self.txtKeyword, btnKeyword))
        btnOperator.clicked['bool'].connect(lambda: self._pick_color(self.txtOperator, btnOperator))
        btnBrace.clicked['bool'].connect(lambda: self._pick_color(self.txtBrace, btnBrace))
        btnDefinition.clicked['bool'].connect(lambda: self._pick_color(self.txtDefinition, btnDefinition))
        btnString.clicked['bool'].connect(lambda: self._pick_color(self.txtString, btnString))
        btnString2.clicked['bool'].connect(lambda: self._pick_color(self.txtString2, btnString2))
        btnSpaces.clicked['bool'].connect(lambda: self._pick_color(self.txtSpaces, btnSpaces))
        btnExtras.clicked['bool'].connect(lambda: self._pick_color(self.txtExtras, btnExtras))
        btnComment.clicked['bool'].connect(lambda: self._pick_color(self.txtComment, btnComment))
        btnProperObject.clicked['bool'].connect(lambda: self._pick_color(self.txtProperObject, btnProperObject))
        btnNumbers.clicked['bool'].connect(lambda: self._pick_color(self.txtNumbers, btnNumbers))
        btnEditorText.clicked['bool'].connect(lambda: self._pick_color(self.txtEditorText, btnEditorText))
        btnEditorBackground.clicked['bool'].connect(lambda: self._pick_color(self.txtEditorBackground,
                btnEditorBackground))
        btnEditorSelectionColor.clicked['bool'].connect(lambda: self._pick_color(self.txtEditorSelectionColor,
                btnEditorSelectionColor))
        btnEditorSelectionBackground.clicked['bool'].connect(lambda: self._pick_color(self.txtEditorSelectionBackground,
                btnEditorSelectionBackground))
        btnCurrentLine.clicked['bool'].connect(lambda: self._pick_color(self.txtCurrentLine, btnCurrentLine))
        btnSelectedWord.clicked['bool'].connect(lambda: self._pick_color(self.txtSelectedWord, btnSelectedWord))
        btnFoldArea.clicked['bool'].connect(lambda: self._pick_color(self.txtFoldArea, btnFoldArea))
        btnFoldArrow.clicked['bool'].connect(lambda: self._pick_color(self.txtFoldArrow, btnFoldArrow))
        btnLinkNavigate.clicked['bool'].connect(lambda: self._pick_color(self.txtLinkNavigate, btnLinkNavigate))
        btnBraceBackground.clicked['bool'].connect(lambda: self._pick_color(self.txtBraceBackground,
                btnBraceBackground))
        btnBraceForeground.clicked['bool'].connect(lambda: self._pick_color(self.txtBraceForeground,
                btnBraceForeground))
        btnErrorUnderline.clicked['bool'].connect(lambda: self._pick_color(self.txtErrorUnderline,
                btnErrorUnderline))
        btnPep8Underline.clicked['bool'].connect(lambda: self._pick_color(self.txtPep8Underline, btnPep8Underline))
        btnSidebarBackground.clicked['bool'].connect(lambda: self._pick_color(self.txtSidebarBackground,
                btnSidebarBackground))
        btnSidebarForeground.clicked['bool'].connect(lambda: self._pick_color(self.txtSidebarForeground,
        ...
        btnSaveScheme.clicked['bool'].connect(self.save_scheme)
    ...
    def _pick_color(self, lineedit, btn):
        color = QColorDialog.getColor(QColor(lineedit.text()),
            self, _translate("EditorSchemeDesigner", "Choose Color for: "))
        if color.isValid():
    ...
    def save_scheme(self):
        ...
        if not self._is_valid_scheme_name(name):
            QMessageBox.information(self, _translate("EditorSchemeDesigner", "Invalid Scheme Name"),
                _translate("EditorSchemeDesigner", "The scheme name you have chosen is invalid.\nPlease "
        ...
        if file_manager.file_exists(fileName):
            answer = QMessageBox.question(self,
                _translate("EditorSchemeDesigner", "Scheme already exists"),
                (_translate("EditorSchemeDesigner", "Do you want to override the file: %s?") % fileName),
        ...
        if name != '' and answer in (QMessageBox.Yes, True):
            ...
            QMessageBox.information(self, _translate("EditorSchemeDesigner", "Scheme Saved"),
                    (_translate("EditorSchemeDesigner", "The scheme has been saved at: %s.") % fileName))
        elif answer == QMessageBox.Yes:
            QMessageBox.information(self, _translate("EditorSchemeDesigner", "Scheme Not Saved"),
                _translate("EditorSchemeDesigner", "The name probably is invalid."))
...
class ThemeTab(QTabWidget):
    ...
    def __init__(self):
        ...
        self.addTab(self.theme_chooser, _translate("ThemeTab", "EditorSchemeDesigner", "Theme Chooser"))
        self.addTab(self.theme_designer, _translate("ThemeTab", "Theme Designer"))
...
class ThemeChooser(QWidget):
    ...
    def __init__(self):
        ...
        vbox.addWidget(QLabel(_translate("ThemeChooser", "<b>Select Theme:</b>")))
        self.list_skins = QListWidget()
        self.list_skins.setSelectionMode(QListWidget.SingleSelection)
        vbox.addWidget(self.list_skins)
        self.btn_delete = QPushButton(_translate("ThemeChooser", "Delete Theme"))
        self.btn_preview = QPushButton(_translate("ThemeChooser", "Preview Theme"))
        hbox = QHBoxLayout()
...
class ThemeDesigner(QWidget):
    ...
    def __init__(self, parent):
        ...
        hbox = QHBoxLayout()
        hbox.addWidget(QLabel(_translate("ThemeDesigner", "<b>New Theme Name:</b>")))
        self.line_name = QLineEdit()
        hbox.addWidget(self.line_name)
        self.btn_save = QPushButton(_translate("ThemeDesigner", "Save Theme"))
        ...
        self.btn_apply = QPushButton(_translate("ThemeDesigner", "Apply Style Sheet"))
        hbox2 = QHBoxLayout()
    ...
    def save_stylesheet(self):
        try:
            ...
            QMessageBox.information(self, _translate("ThemeDesigner", "Style Sheet Saved"),
                (_translate("ThemeDesigner", "Theme saved at: '%s'." % file_name)))
            self.edit_qss.document().setModified(False)
        except file_manager.NinjaFileExistsException as ex:
            QMessageBox.information(self, _translate("ThemeDesigner", "File Already Exists"),
                (_translate("ThemeDesigner", "Invalid File Name: the file '%s' already exists.") %
                    ex.filename))
