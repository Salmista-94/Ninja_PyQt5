...
class WizardNewProject(QWizard):
    ...
    def __init__(self, parent):
        super(WizardNewProject, self).__init__(parent)
        self.__explorer = parent
        self.setWindowTitle(_translate("WizardNewProject", "NINJA - New Project Wizard"))
                ...
                if venv:
                    ...
                    if not os.path.exists(venv):
                        btnPressed = QMessageBox.information(self,
                            _translate("WizardNewProject", "Virtualenv Folder"),
                            _translate("WizardNewProject", "Folder don't exists or this is not a "
                                "valid Folder.\n If you want to set "
                                "or modify, go to project properties"),
                            _translate("WizardNewProject", "Back"),
                            _translate("WizardNewProject", "Continue"))
...
class PageProjectProperties(QWizardPage):
    ...
    def __init__(self):
        super(PageProjectProperties, self).__init__()
        self.setTitle(_translate("PageProjectProperties", "New Project Data"))
        self.setSubTitle(_translate("PageProjectProperties", 
            "Complete the following fields to create the Project Structure"))

        gbox = QGridLayout(self)
        #Names of the fields to complete
        self.lblName = QLabel(_translate("PageProjectProperties", "New Project Name (*):"))
        self.lblPlace = QLabel(_translate("PageProjectProperties", "Create in (*):"))
        self.lblDescription = QLabel(_translate("PageProjectProperties", "Project Description:"))
        self.lblLicense = QLabel(_translate("PageProjectProperties", "Project License:"))
        self.lblVenvFolder = QLabel(_translate("PageProjectProperties", "Virtualenv Folder:"))
        ...
        self.btnExamine = QPushButton(_translate("PageProjectProperties", "Browse..."))
        ...
        self.vbtnExamine = QPushButton(_translate("PageProjectProperties", "Browse..."))
        ...
        #Signal
        self.btnExamine.clicked['bool'].connect(self.load_folder)
        self.vbtnExamine.clicked['bool'].connect(self.load_folder_venv)
        self.txtName.textChanged[str].connect(self.completeChanged.emit)
    ...
    def load_folder(self):
        self.txtPlace.setText(QFileDialog.getExistingDirectory(
            self, _translate("PageProjectProperties", "New Project Folder")))
        self.completeChanged.emit()

    def load_folder_venv(self):
        self.vtxtPlace.setText(QFileDialog.getExistingDirectory(
            self, _translate("PageProjectProperties", "Select Virtualenv Folder")))
