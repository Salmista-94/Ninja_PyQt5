...
class LanguagesManagerWidget(QDialog):
    ...
    def __init__(self, parent):
        ...
        self.setWindowTitle(_translate("LanguagesManagerWidget", "Language Manager"))
        self.resize(700, 500)
        ...
        # Footer
        hbox = QHBoxLayout()
        btn_close = QPushButton(_translate("LanguagesManagerWidget", 'Close'))
        btnReload = QPushButton(_translate("LanguagesManagerWidget", "Reload"))
    ...
    def load_languages_data(self):
        if self._loading:
            ...
            self._tabs.addTab(self._languageWidget,
                _translate("LanguagesManagerWidget", "Languages"))
            self._loading = False
        self.overlay.hide()
        self._thread.wait()
...
class LanguageWidget(QWidget):
    ...
    def __init__(self, parent, languages):
        ...
        ui_tools.load_table(self._table,
            [_translate("LanguagesManagerWidget", 'Language'), _translate("LanguagesManagerWidget", 'URL')], self._languages)
        btnUninstall = QPushButton(_translate("LanguagesManagerWidget", 'Download'))
