...
class MenuPlugins(QObject):
    ...
    def __init__(self, menuPlugins):
        super(MenuPlugins, self).__init__()

        manageAction = menuPlugins.addAction(_translate("MenuPlugins", "Manage Plugins"))
        skinsAction = menuPlugins.addAction(_translate("MenuPlugins", "Editor Schemes"))
        languagesAction = menuPlugins.addAction(_translate("MenuPlugins", "Languages Manager"))
        menuPlugins.addSeparator()

        manageAction.triggered.connect(self._show_manager)
        skinsAction.triggered.connect(self._show_themes)
        languagesAction.triggered.connect(self._show_languages)
