    ...
    def _load_results(self):
        if len(self._thread.results) == 1:
            ...
            QMessageBox.information(main_container.MainContainer(),
                                    _translate("Locator", "Definition Not Found"),
                                    _translate("Locator", "This Definition does not "
...
class CodeLocatorWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self._btnGo = QPushButton(
            self.style().standardIcon(QStyle.SP_ArrowRight), _translate("CodeLocatorWidget", 'Go!'))
...
class LocateCompleter(QLineEdit):
    ...
    def __init__(self, parent):
        super(LocateCompleter, self).__init__(parent)
        self._parent = parent
        self.__prefix = ''
        ...
        self.textChanged[str].connect(self.set_prefix)

        self.frame.listWidget.itemPressed['QListWidgetItem*'].connect(self._go_to_location)
...
class PopupCompleter(QFrame):
    ...
    def __init__(self):
        super(PopupCompleter, self).__init__(None, Qt.FramelessWindowHint | Qt.ToolTip)
        ...
        self.listWidget.currentItemChanged['QListWidgetItem*', 'QListWidgetItem*'].connect(self._repaint_items)
