...
###############################################################################
    ...
    def test_module_class_func_attrs(self):
        ...
        result_f = list(module.functions.keys())
        result_f.sort()
        result_a = list(module.attributes.keys())
        result_a.sort()
        result_c = list(module.classes.keys())
    ...
    def test_attrs_in_module_func(self):
        ...
        #Assign: 1
        result_a = list(func.attributes.keys())
        result_a.sort()
    ...
    def test_simple_class_data(self):
        ...
        result_f = list(clazz.functions.keys())
        result_f.sort()
        result_a = list(clazz.attributes.keys())
        result_a.sort()
